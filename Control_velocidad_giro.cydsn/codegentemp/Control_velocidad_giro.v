...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("af8350ef-1676-466a-9008-9a1ccb45c6bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Trigger_in_net;
	wire [0:0] tmpIO_0__Trigger_in_net;
	wire [0:0] tmpINTERRUPT_0__Trigger_in_net;
	electrical [0:0] tmpSIOVREF__Trigger_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Trigger_in
		 (.oe(tmpOE__Trigger_in_net),
		  .y({1'b0}),
		  .fb({Net_454}),
		  .io({tmpIO_0__Trigger_in_net[0:0]}),
		  .siovref(tmpSIOVREF__Trigger_in_net),
		  .interrupt({tmpINTERRUPT_0__Trigger_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Trigger_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("628471a7-9a27-4b8f-b257-78958b322cef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9c4085e0-2d9d-4176-b967-5062b68ce33a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f9a56f4d-2ee4-473e-97fe-e59f51e70ed7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bea7e385-f8c6-4d5e-a7be-beee36e5f1ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
