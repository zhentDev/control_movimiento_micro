// ======================================================================
// Control_velocidad_giro.v generated from TopDesign.cysch
// 03/19/2023 at 16:39
...
module top ;
	...
	wire [0:0] tmpOE__outPWM_net;
	wire [0:0] tmpFB_0__outPWM_net;
	wire [0:0] tmpIO_0__outPWM_net;
	wire [0:0] tmpINTERRUPT_0__outPWM_net;
	electrical [0:0] tmpSIOVREF__outPWM_net;

	cy_psoc3_pins_v1_10
		#(.id("acb18b60-1e10-4281-8ba3-72924b997bb1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		outPWM
		 (.oe(tmpOE__outPWM_net),
		  .y({Net_385}),
		  .fb({tmpFB_0__outPWM_net[0:0]}),
		  .io({tmpIO_0__outPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__outPWM_net),
		  .interrupt({tmpINTERRUPT_0__outPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__outPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("57bc49ab-4264-48ea-9dbd-b2e26eb68ac9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000"),
		  .is_direct(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_293)
    begin
        cy_tff_1 <= Net_296^Net_295;
    end
    assign Net_295 = cy_tff_1;
    // -- TFF End --
	...
	wire [0:0] tmpOE__outTimer_net;
	wire [0:0] tmpFB_0__outTimer_net;
	wire [0:0] tmpIO_0__outTimer_net;
	wire [0:0] tmpINTERRUPT_0__outTimer_net;
	electrical [0:0] tmpSIOVREF__outTimer_net;

	cy_psoc3_pins_v1_10
		#(.id("902b82a4-dd85-4360-b82b-add660214c0c"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		outTimer
		 (.oe(tmpOE__outTimer_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__outTimer_net[0:0]}),
		  .io({tmpIO_0__outTimer_net[0:0]}),
		  .siovref(tmpSIOVREF__outTimer_net),
		  .interrupt({tmpINTERRUPT_0__outTimer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__outTimer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3ac842a2-a271-4afa-8539-1ffb22936613"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__rigth_net;
	wire [0:0] tmpFB_0__rigth_net;
	wire [0:0] tmpIO_0__rigth_net;
	wire [0:0] tmpINTERRUPT_0__rigth_net;
	electrical [0:0] tmpSIOVREF__rigth_net;

	cy_psoc3_pins_v1_10
		#(.id("dde3f969-3413-4abb-ae59-3f45a57eeecc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		rigth
		 (.oe(tmpOE__rigth_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__rigth_net[0:0]}),
		  .io({tmpIO_0__rigth_net[0:0]}),
		  .siovref(tmpSIOVREF__rigth_net),
		  .interrupt({tmpINTERRUPT_0__rigth_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rigth_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
