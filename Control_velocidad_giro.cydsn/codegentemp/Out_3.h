...
*/
     ...
     *  @{
     */
        #define Out_3_INTR_NONE      (uint16)(0x0000u)
        #define Out_3_INTR_RISING    (uint16)(0x0001u)
        #define Out_3_INTR_FALLING   (uint16)(0x0002u)
        #define Out_3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Out_3_INTR_MASK      (0x01u) 
#endif /* (Out_3__INTSTAT) */
...
/* SIO registers */
#if defined(Out_3__SIO_CFG)
    #define Out_3_SIO_HYST_EN        (* (reg8 *) Out_3__SIO_HYST_EN)
    #define Out_3_SIO_REG_HIFREQ     (* (reg8 *) Out_3__SIO_REG_HIFREQ)
    #define Out_3_SIO_CFG            (* (reg8 *) Out_3__SIO_CFG)
    #define Out_3_SIO_DIFF           (* (reg8 *) Out_3__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Out_3_0_INTTYPE_REG 		(* (reg8 *) Out_3__0__INTTYPE)
#endif /* (Out_3__INTSTAT) */
