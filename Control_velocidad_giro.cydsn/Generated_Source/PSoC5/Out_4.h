...
void    Out_4_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Out_4_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Out_4__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Out_4_SetInterruptMode() function.
     *  @{
     */
        #define Out_4_INTR_NONE      (uint16)(0x0000u)
        #define Out_4_INTR_RISING    (uint16)(0x0001u)
        #define Out_4_INTR_FALLING   (uint16)(0x0002u)
        #define Out_4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Out_4_INTR_MASK      (0x01u) 
#endif /* (Out_4__INTSTAT) */
...
/* SIO registers */
#if defined(Out_4__SIO_CFG)
    #define Out_4_SIO_HYST_EN        (* (reg8 *) Out_4__SIO_HYST_EN)
    #define Out_4_SIO_REG_HIFREQ     (* (reg8 *) Out_4__SIO_REG_HIFREQ)
    #define Out_4_SIO_CFG            (* (reg8 *) Out_4__SIO_CFG)
    #define Out_4_SIO_DIFF           (* (reg8 *) Out_4__SIO_DIFF)
#endif /* (Out_4__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Out_4_0_INTTYPE_REG 		(* (reg8 *) Out_4__0__INTTYPE)
#endif /* (Out_4__INTSTAT) */
